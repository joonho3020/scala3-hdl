...
final case class InnerBundleIf(a: UInt, b: UInt) extends BundleIf
final case class MyBundleIf(x: UInt, y: UInt, i: InnerBundleIf) extends BundleIf

def instantiation_check(): Unit =
  val mb = Bundle(MyBundleIf(
    x = UInt(Width(2)),
    y = UInt(Width(3)),
    i = InnerBundleIf(
      a = UInt(Width(4)),
  ...
  inline val tc1 = """
  val rg: Bundle[MyBundleIf] = Reg(mb)
  val reg_x: UInt = rg.x
  val reg_y: UInt = rg.y
  val reg_i: Bundle[InnerBundleIf] = rg.i
...
// // lux = UInt(Width(6))))
// 
//   case class SimpleBundle(a: UInt, b: UInt) extends Bundle
//   case class OptBundle2(
//     a: Option[SimpleBundle],
//     b: UInt,
//     c: UInt) extends Bundle
// 
//   val io_2 = IO(OptBundle2(
//     a = Some(SimpleBundle(
//       a = UInt(Width(2)),
//       b = UInt(Width(3))
//     )),
